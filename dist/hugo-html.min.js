...
},contains:[a]},i={begin:[/\.(?=\w+)/],beginScope:{1:"template-variable.context"
},contains:[a]},o={variants:[{begin:/\w+(?=\.)/,contains:[a]},{match:/\w+/}],
keywords:{$pattern:/\w+/,
built_in:["findRESubmatch","partialCached","base64Decode","base64Encode","htmlUnescape","safeHTMLAttr","fingerprint","markdownify","singularize","absLangURL","complement","countrunes","countwords","dateFormat","fileExists","htmlEscape","newScratch","relLangURL","anchorize","hasPrefix","hasSuffix","highlight","intersect","pluralize","replaceRE","safeJSStr","unmarshal","duration","erroridf","humanize","plainify","readFile","safeHTML","slicestr","truncate","urlquery","default","delimit","emojify","getJSON","jsonify","keyVals","modBool","partial","postCSS","println","querify","readDir","replace","safeCSS","safeURL","shuffle","symdiff","warnidf","absURL","append","errorf","findRE","getCSV","getenv","minify","printf","relref","relURL","safeJS","sha256","string","substr","urlize","xxhash","after","apply","babel","chomp","first","float","group","index","isset","lower","merge","print","slice","split","title","toCSS","union","upper","warnf","where","cond","dict","hmac","i18n","last","page","sha1","site","sort","time","trim","uniq","add","and","div","int","len","md5","mod","mul","not","now","pow","ref","seq","sub","eq","ge","gt","in","le","lt","ne","or","T"],
literal:["false","true","nil"]}},n={variants:[{begin:[/\$\w+(?=\.)/],
beginScope:{1:"template-variable"},contains:[a]},{match:/\$\w+/,
scope:"template-variable"}]},l={begin:[/\(/],beginScope:{1:"punctuation"},
end:[/\)/],endScope:{1:"punctuation"}
},c=[e.NUMBER_MODE,e.QUOTE_STRING_MODE,e.APOS_STRING_MODE,{scope:"string.raw",
match:/`[^`]*`/,keywords:[]},r,o,i,n,{scope:"operator",match:/[|,=]|:=/},{
scope:"template-variable.context",match:/\.|\$/},l];return l.contains=c,{
name:"highlightjs-hugo-html",case_insensitive:!1,aliases:["hugo"],
subLanguage:["xml"],
...
1:"template-tag"},contains:c}]}}})();hljs.registerLanguage("hugo-html",e)})();